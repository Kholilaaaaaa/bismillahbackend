...
Route::middleware(['auth:admin'])->group(function () {
    ...
    Route::post('/admin/feedback/analyze-sentiment', [FeedbackPenggunaController::class, 'analyzeSentiment'])->name('feedback.analyze-sentiment');
    Route::get('/admin/feedback/sentiment-results', [FeedbackPenggunaController::class, 'getSentimentResults'])->name('feedback.sentiment-results');
    Route::get('/admin/feedback/sentiment-stats', [FeedbackPenggunaController::class, 'getSentimentStats'])->name('feedback.sentiment-stats');
    ...
    // ======================
    // Main Page
    Route::get('/admin/manajemen-chatbot', function () {
        return view('admins.manajemen-chatbot.index');
    })->name('manajemen-chatbot.index');
    

    Route::get('/all', [ManajemenChatbotController::class, 'getAll'])->name('getAll');
    Route::post('/{id}/toggle-active', [ManajemenChatbotController::class, 'toggleActive'])->name('toggleActive');
    
    // Dashboard Statistics
    Route::get('/admin/manajemen-chatbot/dashboard', [ManajemenChatbotController::class, 'index'])->name('manajemen-chatbot.dashboard');
    
    // Knowledge Management
    Route::get('/admin/manajemen-chatbot/list', [ManajemenChatbotController::class, 'listKnowledge'])->name('manajemen-chatbot.list');
    Route::get('/admin/manajemen-chatbot/search', [ManajemenChatbotController::class, 'search'])->name('manajemen-chatbot.search');
    
    // Import/Add Data
    Route::post('/admin/manajemen-chatbot/csv', [ManajemenChatbotController::class, 'storeCSV'])->name('manajemen-chatbot.storeCSV');
    Route::post('/admin/manajemen-chatbot/manual', [ManajemenChatbotController::class, 'storeManual'])->name('manajemen-chatbot.storeManual');
